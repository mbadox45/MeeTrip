        ...
        <div class="col-12 md:col-12">
            <div class="flex align-items-center justify-content-end md:justify-content-between">
                <div class="">
                    ...
                    <strong class="text-2xl md:text-5xl font-normal">BTO - {{ routes == '/bto-spdk' ? payload.type == 'adminga' ? 'Down Payment' : 'Approve by Human Capital' : 'Surat Jalan' }}</strong>
                </div>
                <div class="hidden md:block">
                    <strong class="text-500 font-light">SPDK <i class="pi pi-angle-double-right mx-2"></i> BTO - {{ routes == '/bto-spdk' ? payload.type == 'adminga' ? 'Down Payment' : 'Approve' : 'Surat Jalan' }} <i class="pi pi-angle-double-right mx-2" v-show="payload.type != 'adminga'"></i> {{payload.type == 'adminga' ? null: 'Human Capital'}}</strong>
                </div>
            </div>
        </div>
        <div class="col-12 md:col-12">
