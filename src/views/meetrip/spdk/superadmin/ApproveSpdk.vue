<script setup>
    ...
    const aksi = async () => {
        ...
        try {
            ...
            const data = filteredData.filter(item => item.status === 1 || item.status === 5);
            const list = [];
        ...
        <div class="col-12 md:col-12">
            <div class="flex align-items-center justify-content-end md:justify-content-between">
                <div class="">
                    ...
                    <strong class="text-2xl md:text-5xl font-normal">BTO - Approve</strong>
                </div>
                <div class="hidden md:block">
                    <strong class="text-500 font-light">SPDK <i class="pi pi-angle-double-right mx-2"></i> BTO - Approve <i class="pi pi-angle-double-right mx-2"></i> Down Payment</strong>
                </div>
            </div>
        </div>
        <div class="col-12 md:col-12">
