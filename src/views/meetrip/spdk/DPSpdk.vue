<script setup>
    ...
    const form = ref({id:null, kurs_usd:null, sarapan:null, makan_siang:null, makan_malam:null, saku:null, official:null, dualima:null, seratussatu:null, duaratus:null, hotel:null, laundry:null, transport_dilokasi:null, tiket:null, komunikasi:null, airport:null})
            ...
            <div class="grid align-items-end">
                <div class="col-12 md:col-3 sm:col-6 p-fluid">
                    ...
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.kurs_usd" placeholder="" disabled/>
                    </div>
                </div>
                <div class="col-12 md:col-3 sm:col-6 p-fluid">
                    ...
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.sarapan" placeholder="Breakfast Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.makan_siang" placeholder="Lunch Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.makan_malam" placeholder="Dinner Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    ...
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.airport" placeholder="Transport to Airport Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.tiket" placeholder="Ticket Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.transport_dilokasi" placeholder="Local Transport Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.official" placeholder="Official Car"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.dualima" placeholder="025 - 100 KM"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.seratussatu" placeholder="101 - 200 KM"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.duaratus" placeholder="d > 200 KM"/>
                    </div>
                </div>
                ...
                <div class="col-12 md:col-3 p-fluid">
                    ...
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.hotel" placeholder="Hotel Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.laundry" placeholder="Laundry Fee"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.saku" placeholder="Pocket Money"/>
                    </div>
                </div>
                <div class="col-12 md:col-3 p-fluid">
                    <div class="p-inputgroup">
                        ...
                        <InputText v-model="form.komunikasi" placeholder="Communication Fee"/>
                    </div>
                </div>
